    ...
    func setNewVirtualObjectPosition(_ pos: SCNVector3) {
		...
		if object.parent == nil {
            ...
            if (!UserDefaults.standard.bool(for: .addObject1TutorialFulfilled)) {
                ...
                textManager.showAlert(title: "Welcome!", message: "It looks like this is your first time! Would you like a quick tutorial to show you how to make the most of ARAnalysis: \"Virtual Goal\"?", actions: [launchTutorialAction, dismissAction])
            }
		}
    }
